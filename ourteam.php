            ...
            <ul>
                ...
                <section id="ethan">
                    ...
                    <p class="text">My name is Ethan Franks and I am currently a 3rd year Network Technology student at Carleton University and I am this group project's co-frontend 
                                    ...
                                    I also helped connect the back-end developers’ database to the forms that users see and fill out so that their usernames and info would be acessed/stored properly.</p>
                ...
                <p class="text">My name is Kevin Zhong and I am currently a 3rd year Network Technology student at Carleton University and I am this group project's co-frontend developer. 
                    ...
                    <li class="emailbullets"> Carleton email: <a href="mailto:kevinzhong@cmail.carleton.ca">kevinzhong@cmail.carleton.ca</a></li>
                    <li class="emailbullets"> Algonquin email: <a href="mailto:zhon0033@algonquinlive.com">zhon0033@algonquinlive.com</a></li> </p>
                </section>
                ...
                <p class="text">My name is Tarnvir Hans and I am currently a 3rd year Network Technology student at Carleton University and I am this group project's co-backend developer.
                    ...
                    <li class="emailbullets"> Carleton email: <a href="mailto:tarnvirhans@cmail.carleton.ca">tarnvirhans@cmail.carleton.ca</a></li>
                    <li class="emailbullets"> Algonquin email: <a href="mailto:hans0204@algonquinlive.com">hans0204@algonquinlive.com</a></li> </p>
                </section>
                ...
                <p class="text">My name is Adeeb Fahim and I am currently a 3rd year Network Technology student at Carleton University and I am this group project's co-backend developer. 
                    ...
                    <li class="emailbullets"> Carleton email: <a href="mailto:adeebfahim@cmail.carleton.ca">adeebfahim@cmail.carleton.ca</a></li>
                    <li class="emailbullets"> Algonquin email: <a href="mailto:fahi0016 @algonquinlive.com">fahi0016 @algonquinlive.com</a></li> </p>
                </section>
            </ul>
